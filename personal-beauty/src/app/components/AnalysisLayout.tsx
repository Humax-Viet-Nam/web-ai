  ...
  ({
    ...
    useEffect(() => {
      if (detectionResults?.hand?.isIndexRaised) {
        setStatusMessage(
          "Hand detected (index finger raised). Please lower your hand to continue analysis."
        );
        setProgress(0);
      } else {
    ...
    const statusIcon = useMemo(() => {
      if (statusMessage.toLowerCase().includes("hand detected"))
        return (
          <svg
          ...
          >
            <path
              ...
              strokeWidth="2"
              d="M12 4v1m0 14v1m-6-6h1m10 0h-1M5.757 5.757l.707.707m11.072 11.072l-.707.707M5.757 18.243l.707-.707m11.072-11.072l-.707-.707M12 12h.01"
            />
          </svg>
        );
      if (statusMessage.toLowerCase().includes("face not detected"))
        return (
          <svg
            className="w-5 h-5 mr-2"
            fill="none"
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 flex-1 overflow-hidden">
          ...
          >
            ...
            >
              ...
              {statusMessage.toLowerCase().includes("put your hands on") &&
                guideMessage && (
                  <div className="absolute inset-0 bg-black/[.15] z-[20] flex flex-col items-center flex-start">
                    <svg
                      className="w-12 h-12 text-white my-2"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2"
                      viewBox="0 0 24 24"
              ...
              {!result &&
                statusMessage.toLowerCase().includes("face not detected") && (
                  <div className="absolute inset-0 bg-black z-[20] bg-opacity-50 flex flex-col items-center justify-center animate-pulse">
                    <svg
                      className="w-12 h-12 text-white mb-4"
                      fill="none"
          ...
          >
                ...
                <div className="flex items-center gap-2">
                  ...
                  {result.toLowerCase() === "neutral" && (
                    <svg
                      ...
                      viewBox="0 0 24 24"
                    >
                      <path d="M12 2a10 10 0 0 1 10 10c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zm0 2a8 8 0 0 0-8 8c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8zm-4 4h8v2H8zm0 4h8v2H8z" />
                    </svg>
                  )}
            ...
            {colorPalette && (
              <div className="flex-1 mt-2">
                ...
                <div className="animate-fadeIn">{colorPalette}</div>
              </div>
            )}
